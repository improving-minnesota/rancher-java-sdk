...
interface SubscribeApi {
  ...
  @GET("projects/{projectId}/subscribe")
  Call<TypeCollection<Subscribe>> query(@Path("projectId") String projectId, @QueryMap Filters<String, String> filters)
